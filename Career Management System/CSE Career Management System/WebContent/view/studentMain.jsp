...
<body>
	...
	%>
	<div id = "home">
		<a href = "./studentMain.jsp"><img src = "../img/컴퓨터학부.png" width = "130" height = "50" style = "padding-top: 30px; padding-left : 13px;"></a>
	</div>
	<div id = "info">
		<span id = "text">
	...
	<div id = "menu">
		<span style = "display : inline-block; padding-left : 2%; padding-top : 2%;">
			<a href = "../navigation/courseGrade.jsp" target = "list" >이수성적</a> &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
			<a href = "../navigation/creditStatus.jsp" target = "list">충족현황</a> &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
			<a href = "../navigation/requirements.jsp" target = "list">졸업요건</a> &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
			<a href = "../navigation/qna.jsp" target = "list">Q&A</a>
		</span>
	</div>
