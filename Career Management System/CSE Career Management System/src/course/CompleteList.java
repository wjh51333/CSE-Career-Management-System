...
public class CompleteList {
	...
	private int refinegrade; // 교양
	private int basicrefine; // 기본소양
	private int majorbase; // 전공기반
	private int enginmajor; // 공학전공
	...
	public void calgrade(String filename) {
        ...
        d.mdfile2(filename2+"공학전공.txt");
        d.mdfile2(filename2+"기본소양.txt");
        d.mdfile2(filename2+"교양.txt");
        d.mdfile2(filename2+"전공기반.txt");
