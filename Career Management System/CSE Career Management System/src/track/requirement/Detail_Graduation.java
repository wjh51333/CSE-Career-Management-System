...
public class Detail_Graduation 
{
	...
	public void open_detailed_graduation_requirement(String Filename) // 세부졸업요건 읽어오기
	{
		...
		detailList = d.open_detail_graduation(Filename);
	...
	public void store_detailed_graduation_requirement(account.Account a, String Filename) // 세부졸업요건 저장하기
	{
		Detail_Data d = new Detail_Data();
		d.store_detail_graduation(a, detailList, Filename);
