...
<body>
	<div id = "home">
		<a href = "adminMain.jsp"><img src = "컴퓨터학부.png" width = "130" height = "50" style = "padding-top: 30px; padding-left : 13px;"></a>
	</div>
	<div id = "info">
		<span id = "text">
			이름 (아이디 / 교직원번호) &nbsp;&nbsp;&nbsp;&nbsp; 
	...
	<div id = "menu">
		<span style = "display : inline-block; padding-left : 2%; padding-top : 2%;">
			<a href = "manageReq.jsp" target = "list" >졸업요건 관리</a> &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
			<a href = "manageQna.jsp" target = "list">Q&A</a>
		</span>
	</div>

	<iframe src = "courseGrade.jsp" name = "list" width = "12.5%" height = "300vh" style = "border : none; float : left;"></iframe>
